...
def AtomicWrite(path: str | PathLike[str], data: bytes):
	"""
...
def GetRandomFile(directory: str | PathLike[str]) -> Path | None:
	"""
...
def RemoveDirectoryContent(directory: str | PathLike[str]):
	"""
...
def ReadJSON(path: str | PathLike[str]) -> dict:
	"""
...
def WriteJSON(path: str | PathLike[str], data: dict, pretty: bool = True, atomic: bool = False):
	"""
...
def ReadYAML(path: str | PathLike[str]) -> dict:
	"""
...
def WriteYAML(path: str | PathLike[str], data: dict, atomic: bool = False):
	"""
